<template>
	<div class="card card-body-blog black-color">
		...
		<div class="card-header w-100">
			<button class="btn btn-success float-right" data-toggle="modal" data-target="#categoryModal" @click="createNew()">Create category</button>
		</div>
		...
		<div class="card-body">
			...
			class="table-hover"
			:css="css.table"
			:api-url="'/api/categories?paginate=1&name=' + name"
			:fields="fields"
			data-path="data"
			pagination-path=""
			...
			<template slot="actions" slot-scope="props">
				<div class="table-button-container">
					<button class="btn btn-primary" data-toggle="modal" data-target="#categoryModal" @click="viewItem(props.rowData)"><i class="fa fa-pencil  mr-1"></i>Edit</button>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label>Name</label>
						<input type="text" class="form-control br-dark-blue" v-model="form.name" :placeholder="name" id="category_name">
					</div>
